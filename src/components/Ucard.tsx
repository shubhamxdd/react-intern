    ...
    <div className="flex flex-col w-[33%] max-md:ml-0 max-md:w-full py-5">
      <div className="flex flex-col pb-14 text-sm font-semibold max-md:mt-4">
        <div className="flex relative flex-col px-5 pt-20 w-full aspect-[1.29]">
          ...
          />
          <div className="shadow-lg flex z-10 flex-col p-3 mt-14 mb-0 relative top-[50%] w-full rounded-md  bg-slate-100 max-md:mt-10 max-md:mb-2.5">
            <div className="leading-2 text-lg text-center text-neutral-500">
              {title}
            </div>
            <div className="flex gap-1.5 items-center mx-10 justify-center px-14 py-1.5 mt-3 text-green-500 whitespace-nowrap leading-[140%] max-md:px-5">
              <div className="grow flex">
                Readmore <FaArrowRight size={20} className="mx-2" />
              </div>
            </div>
          </div>
        </div>
